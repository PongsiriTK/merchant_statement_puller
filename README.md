...
ถ้าคุณเป็นเจ้าของร้านอาหารที่ขายผ่านแอปส่งอาหาร เครื่องมือนี้ช่วยคุณได้ครับ
...
> อยากให้รองรับ LINE MAN, Foodpanda หรือแพลตฟอร์มอื่น? [เปิด Issue](https://github.com/PongsiriTK/merchant-statement-puller/issues) บอกได้เลยครับ
...
> **เรื่องความปลอดภัย:** ไฟล์นี้มี App Password อยู่ — อย่าแชร์หรือ commit ขึ้น git นะครับ ไฟล์ `*merchant*.md` ถูก gitignore ไว้ให้แล้ว
...
ได้ครับ สร้างไฟล์ตั้งค่าแยกแต่ละร้าน แล้วรันแยกกัน:
...
ได้ครับ ใช้ Python 3.10+ บน Windows, macOS, หรือ Linux ได้เหมือนกัน
...
สร้างไฟล์ Parser ใหม่ แล้วลงทะเบียนในระบบ — ดูตัวอย่างจาก `src/parsers/grab.py` ได้เลยครับ:
...
ยินดีคุยครับ ไม่ว่าจะอยากรวมเข้าระบบ POS, สร้างเป็น SaaS, หรือใช้ในองค์กร — ติดต่อมาคุยกันได้:

> **GitHub:** [@PongsiriTK](https://github.com/PongsiriTK)
>
> **Email:** pongsiri.tk@gmail.com — ใส่ subject `[Commercial License] Merchant Statement Puller`
